...
class QUICHeader(Packet):
    ...
    fields_desc = [
        ...
        # StrFixedLenField("Length",(1174).to_bytes(2,byteorder="big"),2),
        # StrFixedLenField("Length",string_to_ascii("6bafa3cda6256d3c"),2),
...
parameter_named = { 0x01 : "max_idle_timeout" ,
                    0x04 : "initial_max_data",
                    0x05 : "initial_max_stream_data_bidi_local",
                    0x06 : "initial_max_stream_data_bidi_remote",
                    0x07 : "initial_max_stream_data_uni",
                    0x08 : "initial_max_stream_bidi",
                    0x09 : "initial_max_strem_uni",
                    0x0a : "ack_delay_exponet",
                    0x0b : "max_ack_delay",
...
class Parameter(Packet):
    name = "Parameter"
    fields_desc = [
                # ShortEnumField("Type", None, parameter_named),
                #    FieldLenField("len", None, length_of="value"),
...
def TLSObject() :
    ...
    return TLSClientHello(
            ...
            sidlen=0,
            sid = None,
            random_bytes=  "00" * 32  ,#bytes.fromhex(random.getrandbits(32)),
            cipherslen= 6,
