...
class CryptoFrame(Packet) :
    ...
    def TLSObject() :
        return TLSClientHello(
                ...
                comp = [0],
                extlen = 326,
                ext= [TLS_Ext_KeyShare_CH(client_shares=[KeyShareEntry(group = "x25519", kxlen = 32,key_exchange = SessionInstance.get_instance().public_values_bytes) ,KeyShareEntry(group = "secp256r1"),KeyShareEntry(group = "x448") ],len= 167,client_shares_len=165 ),
                      ...
                      TLS_Ext_ALPN(protocols = [ProtocolName(len = 2 , protocol = "h3") , ProtocolName(len = 5 , protocol = "h3-32" ),ProtocolName(len = 5 , protocol = "h3-31"),ProtocolName(len = 5 , protocol = "h3-30"),ProtocolName(len = 5 , protocol = "h3-29")], len = 29, protocolslen = 27),
